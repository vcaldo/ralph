...
SELECTED_CLI="claude"      # Configurable via --cli flag or RALPH_CLI env var, defaults to claude
...
if [[ -z "${1:-}" ]]; then
    ...
    echo "  $0 --cli opencode --provider github-copilot plans/arena-v2/  # Use GitHub Copilot provider"
    exit 1
fi
